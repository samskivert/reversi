...
import com.samskivert.reversi.client.SimpleContext;
    ...
    implements TurnGameController
{
    ...
    public void willEnterPlace (PlaceObject plobj)
    {
        ...
        _color = _gameobj.getPlayerIndex(((SimpleContext)_ctx).getUsername());
    ...
    {
        _panel = new ReversiPanel((SimpleContext)ctx, this);
        return _panel;
    }
    ...
    protected void gameDidEnd ()
    {
        ...
        SimpleContext tctx = (SimpleContext)_ctx;
